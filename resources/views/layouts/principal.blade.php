...
<body>
	...
	<div class="full">
			<div class="menu">
				<ul>
					<li><a class="active" href="{{route('index')}}"><i class="home"></i></a></li>
					<li><a href="{{route('reviews')}}"><div class="cat"><i class="watching"></i><i class="watching1"></i></div></a></li>
					<li><a href="{{route('contacto')}}"><div class="cnt"><i class="contact"></i><i class="contact1"></i></div></a></li>
				</ul>
			</div>
		<div class="main">
